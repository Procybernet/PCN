...
sleep 1
echo ""
echo -e $white"[#]> see you Teman teman:)..."
sleep 1
exit
}
...
echo ""
echo -e "╭─ProCyberNET " |lolcat
echo -e "╭─Pilih Berdasarkan Nomor Pilihan" |lolcat
read -p "╰─#" pil;
...
6) echo "created by : Pro Cyber NET" | lolcat
exit
;;
